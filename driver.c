...
tagGameList gameList[] = {
  ...
  {"cosmicm2",          cosmicm2Rom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  {"galxwarst",          galxwarstRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  {"indianbt",          indianbtRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  {"invrvnge",          invrvngeRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  {"invrvngea",          invrvngeaRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  ...
  {"ozmawars2",          ozmawars2Rom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  ...
  {"invader4",          invader4Rom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  ...
  {"ultrainv",          ultrainvRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  ...
  {"yosakdona",          yosakdonaRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
};
...
/* TODO: Fix these ROM sets
  ...
  {"galxwars2",          galxwars2Rom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  ...
  {"schasercv",          schasercvRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  ...
  {"darthvdr",          darthvdrRom,    init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x04, 0x02, 0x20, 0x40, 0x00, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
  {"schaser",           schaserRom,     init_invaders,  start_invaders,  shutdown_invaders,  interrupt_invaders,  doin_invaders,  doout_invaders,  rdmem_invaders,  wrmem_invaders,  NMI_invaders, save_state_invaders, load_state_invaders, 256, 256, { 0x00, 0x80, 0x10, 0x00, 0x00, 0x00, 0x40, 0x20, 0x02, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
...
//     exit_msg();printf("gns %d %s\r\n",i,gameList[i].gameName);exit_laser(99);
	if(ldebug) printf("Debug: gameList[%d].gameName: %s\r\n", i, gameList[i].gameName);
	...
	driver.s_width = gameList[i].s_width;
	driver.s_height = gameList[i].s_height;
}
...
void check_roms(int argc, char *argv[]) {
	...
	machine_gfx(driver.s_width, driver.s_height);
	if(ldebug) printf("Debug: width: %d, height: %d\r\n", driver.s_width, driver.s_height);
