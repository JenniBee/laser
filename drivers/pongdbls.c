...
int dy2[2] = {0, 0};
int dy4[2] = {0, 0};
const int upkey2[2] = {KEY_W, KEY_8_PAD};
const int downkey2[2] = {KEY_S, KEY_2_PAD};
const int upkey4[2] = {KEY_Y, KEY_P};
const int downkey4[2] = {KEY_H, KEY_COLON};
int score2[2] = {0, 0};
  int lastwinner2 = 1;
  int lastclock2 = 0;
  int title;
...
switch(readkey() >> 8) 
{ 
case KEY_ESC: score2[1] = score2[2] = 11; 
balldone = 1; 
break; 
default: break; 
} 
