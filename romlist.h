...
#define LASER_TOTAL_SUPPORTED 76

extern tagRomList zzzapRom[];
extern tagRomList seawolfRom[];
extern tagRomList gunfightRom[];
extern tagRomList tornbaseRom[];
extern tagRomList mazeRom[];
extern tagRomList boothillRom[];
extern tagRomList checkmatRom[];
extern tagRomList desertguRom[];
extern tagRomList dplayRom[];
extern tagRomList lagunarRom[];
extern tagRomList gmissileRom[];
...
extern tagRomList spcenctrRom[];
extern tagRomList phantom2Rom[];
extern tagRomList bowlerRom[];
extern tagRomList blueshrkRom[];
extern tagRomList invad2ctRom[];
extern tagRomList invaddlxRom[];
extern tagRomList sitvRom[];
extern tagRomList sicvRom[];
...
extern tagRomList sinvzenRom[];
extern tagRomList sinvemagRom[];
